        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8 md:mb-16">
                <div class="w-full flex items-center">
                    ...
                    <!-- Step 3: Current -->
                    <div class="flex items-center relative">
                        <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-teal-600 bg-teal-600 text-center">
                            <span class="text-white text-xl font-bold">3</span>
                        </div>
                        <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-teal-600">যাকাত পরিমাণ</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-5">
                ...
                <div class="space-y-6">
                    <div class="p-4 bg-gray-50 rounded-lg">
                        ...
                        <p class="text-xl text-teal-600 font-bold">৳<?php echo number_format($totalAddableAmount, 2); ?></p>
                    </div>
                    ...
                    <div class="p-6 bg-teal-50 rounded-lg text-center">
                        ...
                        <p class="text-3xl text-teal-600 font-bold">৳<?php echo number_format($zakatAmount, 2); ?></p>
                    </div>
                </div>

                <!-- Action Buttons -->
                <div class="mt-8 flex gap-4">
                    <a href="/wp-content/zakat-calculator-two/#zakat-calculator-section" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 duration-300 ease">
                        নতুন হিসাব করুন
                    </a>
                    <button onclick="window.print()" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-teal-600 text-white hover:bg-teal-700 duration-300 ease">
                        প্রিন্ট করুন
                    </button>
                </div>
            </div>
